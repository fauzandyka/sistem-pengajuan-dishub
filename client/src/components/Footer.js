      ...
      <div className="flex justify-between p-4 flex-col md:flex-row">
        <div className="md:w-1/4 p-4 text-white">
          ...
          <p className="text-justify">
            Pengajuan Perawatan Kendaraan Dinas Kota Balikpapan adalah website
            yang dirancang untuk memudahkan pekerja melakukan pengajuan
            perawatan kendaraan secara online.
          </p>
        </div>
        <div className="md:w-1/4 p-4 text-white">
          ...
          <ul>
            <li>
              ...
              <div className="flex items-center pb-1">
                ...
                <p className="ml-4">
                  Jl. Ruhui Rahayu I No. 5 Balikpapan Selatan
                </p>
              </div>
              <div className="flex items-center pb-1">
